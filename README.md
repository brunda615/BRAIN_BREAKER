...
An interactive, authentic multiplayer Tambola (Housie) web application where teams earn numbers toward their randomly generated 15-number ticket by solving aptitude, math, coding logic, and reasoning puzzles.
